...
> **Automatisch generiert aus `MANIFEST.yaml`** am 2026-04-29 07:39. Diese Datei nicht direkt editieren — YAML ändern und `python3 scripts/render_manifest.py` erneut laufen lassen.
